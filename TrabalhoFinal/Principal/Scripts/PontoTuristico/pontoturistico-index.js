        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return "<a style='font-size: 24px;' class='btn fa fa-edit botao-editar-pontoturistico' data-id='" + row.Id + "'></a>" +
                        "<a style='font-size: 24px;' class='btn fa fa-trash ml-1 botao-excluir-pontoturistico' data-id='" + row.Id + "' data-nome='" + row.Nome + "'></a>";
                }
            }
        ]
    });
